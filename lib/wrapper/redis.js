...
function send_command(func, name) {
    return function () {
        ...
        if (!t)
            return return func.apply(this, arguments);
        ...
        if ('function' === typeof arg_last) {
            var wrapped = wrapper.callbackWrapper(arg_last, name, t, tr);
            ...
            var wrapped = wrapper.callbackWrapper(arg_last[arg_last.length - 1], name, t, tr);
            wrapped._scalex_callback = true;    
